...
<div class="page-header-content d-lg-flex">
    ...
    <div class="collapse d-lg-block my-lg-auto ms-lg-auto" id="page_header">
        <div class="d-sm-flex align-items-center mb-3 mb-lg-0 ms-lg-3">
            <a href="{{ route('managers.create') }}" class="btn btn-outline-primary btn-labeled btn-labeled-start rounded-pill">
            ...
            <tbody>
                @foreach ($users as $key => $manager)
                    <tr>
                        ...
                        <td class="text-center">@include('manager.actions')</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
