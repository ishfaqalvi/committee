<div class="row">
    ...
    <div class="form-group col-md-6 mb-3">
        {{ Form::label('email') }}
        {{ Form::email('email', $member->email, ['class' => 'form-control' . ($errors->has('email') ? ' is-invalid' : ''), 'placeholder' => 'Email','required']) }}
    ...
    <div class="form-group col-md-6 mb-3">
        ...
        {{ Form::number('mobile_number', $member->mobile_number, ['class' => 'form-control' . ($errors->has('mobile_number') ? ' is-invalid' : ''), 'required','placeholder'=>'Mobile Number']) }}
